 ...
 *
 * Return: 1 if no leaf, and 0 otherwise. If node is NULL, return 0
 */
...
/**
 * binary_tree_height - measures t of a binary tree
...
/**
 * binary_tree_is_perfect - checks if a binee is perfect
...
/**
 * binary_tree_is_complete -  checks if actual bi is complete
 * @tree: pointer to the root node of the tree to check
 *
